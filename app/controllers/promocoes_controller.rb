class PromocoesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @promocao.save
        upsell_produto_save
        format.html { redirect_to produto_upsell_promocoes_path(@produto, @upsell), notice: 'Promocao was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @promocao.update(promocao_params)
        upsell_produto_save
        format.html { redirect_to produto_upsell_promocoes_path(@produto, @upsell), notice: 'Promocao was successfully updated.' }
  ...
  private
    ...
    def promocao_params
      params.require(:promocao).permit(:upsell_id, :nome, :tempo_relogio, :se_pago_vai_para, :se_negou_vai_para, :titulo, :subtitulo, :descricao)
    end
end
