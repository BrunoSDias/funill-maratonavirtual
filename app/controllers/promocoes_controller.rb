class PromocoesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @promocao.save
        upsell_produto_save
        format.html { redirect_to edit_produto_upsell_promocoe_path(@produto, @upsell), notice: 'Promocao was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @promocao.update(promocao_params)
        upsell_produto_save
        format.html { redirect_to edit_produto_upsell_promocoe_path(@produto, @upsell), notice: 'Promocao was successfully updated.' }
